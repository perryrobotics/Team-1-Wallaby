...
def medical_center_left():
    ...
    #scored firetruck!!
 	arm_up(50)
  	...
  	backward(900,3000) #hit pipe to align 
    ...
    #Turn to face firepole
 	...
 	backward(900, 1300) #hit back of pipe
  	forward(900, 980)  #forward to get even with fireman
  	left(900,900) #face fireman
  	move_to_black(900, 0, 2700)
  	arm_fireman(50)  # start to grab first fireman
  	forward(800, 295) #go forward to grab fireman
   	msleep(500)
  	right(900, 400)
   	forward(900,50)
  	claw_close(50)
	...
	forward(900, 1150) # got forward to get inline to get second fireman
  	left(900,1000)
  	move_to_black(900, 0, 2700)
	arm_fireman(50)
  	forward(800, 375) #go forward to get fireman
   	msleep(500)
  	right(900, 400)
   	forward(900,50)
    ...
    #GO GET FOURTH FIREMAN!!
  	...
  	forward(900, 1150) #go forward to be in line with fourth cube!
  	left(900,930)
  	move_to_black(900, 0, 2700)
	arm_fireman(50)
  	forward(800, 375)
	...
	arm_fireman(50)
  	forward(800, 375)
  	claw_close(50)  #grabbed it!!!
   	msleep(500)
  	backward(900, 100)
  	right(900, 330)  #turn to score it
  	forward(400, 300)
  	claw_open(50)
  	forward(900, 350)
  	arm_up(50)   #SCORED LAST FIREMAN~~
   	backward(900, 200)
  	right(900, 400)
 	arm_down(50)
  	left(900,400)